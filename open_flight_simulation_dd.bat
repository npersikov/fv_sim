...
bin\fgfs.exe --aircraft=DeliveryDrone --fdm=network,localhost,5501,5502,5503 --fog-fastest --disable-clouds --start-date-lat=2004:00:01:09:00:00 --disable-sound --in-air --enable-freeze --terrain-engine=pagedLOD --lod-levels="1 3 5 7 9" --enable-random-objects --enable-terrasync 
